...
args = Arguments(horizon=12, skip = 24, window = 35, hidCNN=30, hidRNN=30, L1loss=False, data=dataframe, save=f'model_files/LSTNET/lstnet_model_hor_12_win_35_skip_24.pt', output_fun=None,
